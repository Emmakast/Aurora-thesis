...
final_df.to_csv('target_dates_ao_232.csv', index=False)
print("Created target_dates_ao_232.csv with", len(active_days), "Active and", len(neutral_days), "Neutral days.")
