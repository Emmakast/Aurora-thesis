#!/bin/bash
#SBATCH --job-name=sp_ablation_refsp
#SBATCH --nodes=1
...
OUT_FILE="$HOME/aurora_thesis/thesis/benchmark/results_ifs_refsp/physics_evaluation_ifs_ablation_refsp_2020_ifs.csv"

# Ensure the output directory exists
mkdir -p "$(dirname "$OUT_FILE")"

echo "Running Ablation: ref_sp..."
$PY $SCRIPT \
    --year 2020 \
    --model ifs_ablation_refsp \
